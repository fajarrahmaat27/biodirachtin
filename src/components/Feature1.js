  ...
  return <section className='bg-gradient-to-r from-emerald-500 to-emerald-900 font-secondary text-white py-[80px]'>
    ...
    <div className='container mx-auto flex justify-center'>
      <div class="bottlegrid">
        <div className="Bottle mx-auto flex flex-col items-center justify-center">
          <img className='lg:h-[400px] md:h-[300px] sm:h-[300px] h-[250px] ' src={image} alt=""/>
        </div>
        <div className="keunggulan-1 text-center flex justify-center flex-col items-center">
        <FaCheckCircle className='text-2xl'/>
          <p className='text-center max-w-[200px] md:text-sm xl:text-lg text-xs sm:text-xs'>Multiple active inggridient 
          </p>
        </div>
        <div className="keunggulan-2 text-center flex justify-center lg:flex-col flex-col items-center">
        ...
        <div className="keunggulan-3 text-center flex justify-center flex-col items-center">
        <FaCheckCircle className='text-2xl'/>
        ...
        <div className="keunggulan-4 text-center flex justify-center flex-col items-center">
        <FaCheckCircle className='text-2xl'/>
